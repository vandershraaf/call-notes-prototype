<?php
	...
	// PayPal checkout
	define( 'PP_SELLER_APP_ID', 'AU5WuRDbReT28BsRzkZSwiXUzJ3Li83Xbuw0rwMXjoIBQit4dtGNxbRQARkr' );
	define( 'PP_SELLER_APP_SECRET' , 'EFv2xRDlJtVvQzhSJAendrD23ePGrAzSBlH9VayUDkWQQO2NuDxjwnre63vX' );
