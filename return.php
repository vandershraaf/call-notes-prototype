...
<?php
	...
	if ( isset($_GET['code']) ) {
		try {
			...
			setcookie('email', $profile->email);
			setcookie('given_name', $profile->given_name);
			setcookie('family_name', $profile->family_name);
			print_r($profile);
			/*
...
<script>
	...
	top.window.opener.location  = 'http://localhost/calltransfer/home.html';
